...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      {{-- HẾt logo --}}
        ...
        <ul class="nav">
          ...
          <li class="nav-item nav-category">
            <span class="nav-link">Thao tác</span>
          </li>
      ...
      {{-- Hiện toàn bộ loại sản phẩm ở đây --}}		  
          <li class="nav-item menu-items">
                <a class="nav-link" href="http://127.0.0.1:8000/danhsachLoaiSanPham">
                <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://127.0.0.1:8000/danhsachHoaDon">
            <span class="menu-icon">
            <i class="mdi mdi-playlist-play"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="http://127.0.0.1:8000/danhsachCTHoaDon">
        <span class="menu-icon">
        <i class="mdi mdi-playlist-play"></i>
      </span>
  ...
  <li class="nav-item menu-items">
    <a class="nav-link" href="http://127.0.0.1:8000/danhsachMaGiamGia123">
    <span class="menu-icon">
    <i class="mdi mdi-playlist-play"></i>
  </span>
