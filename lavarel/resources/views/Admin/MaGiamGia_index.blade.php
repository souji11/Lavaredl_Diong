...
@section('sidebar')
    ...
    <form action="" role="form">
        <div class="form-group">
            ...
            <input type="search" style="color: red" class="form-control" name="timkiemid" id="" placeholder="Nhập ID mã giảm giá tại đây ">
        </div>
...
@section('content')
  ...
  {{-- <div class="col-lg-6 grid-margin stretch-card"> --}}
    <div class="card">
      <div class="card-body">
        <h2 class="card-title"  style="text-align: center">Mã giảm giá </h2>
        {{-- Không hiểu tại sao ko gọi route đc nên gọi nguyên cái link
        
          --}}
          <a href="http://127.0.0.1:8000/ThemMaGiamGia" type="button" class="btn btn-light btn-fw">Thêm</a><br><br>
